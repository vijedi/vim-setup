...
install_plugin 'lang' 'opt' 'https://github.com/hashivim/vim-terraform.git' 'vim-terraform'
install_plugin 'lang' 'opt' 'https://github.com/pearofducks/ansible-vim.git' 'ansible-vim'
...
install_plugin 'lang' 'opt' 'https://github.com/evanleck/vim-svelte.git' 'vim-svelte'
